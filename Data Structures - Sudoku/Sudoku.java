...
public class Sudoku {
    ...
    // private Cell findUnspecifiedCell() {
    //     return board.findCellWithFewestChoices();
    // }
    ...
    public void generateRandomBoard(int initialValues) {
...
//     //     return solveWithHeuristics();
//     // }
    
//     //     private boolean solveWithHeuristics() {
//     //         Cell cell = board.getMinimumRemainingValuesCell();
    
//     //         if (cell == null) {
//     //             return board.validSolution();
//     //         }
    
//     //         List<Integer> possibleValues = board.getLeastConstrainingValues(cell);
    
//     //         for (int value : possibleValues) {
//     //             cell.setValue(value);
//     //             if (solveWithHeuristics()) {
//     //                 return true;
//     //             }
//     //             cell.setValue(0);
//     //         }
...
//     //Extension1
//     public boolean solve() {
//         if (board.getUnspecifiedCells() == 0) {
//             return board.validSolution();
//         }
    
//         Cell nextCell = board.findCellWithFewestChoices();
//         if (nextCell == null) {
//             return false;
//         }
